  ...
  <body class="w3-light-grey">
    ...
    <nav class="w3-sidebar w3-collapse w3-white w3-animate-left" id="mySidebar" style="z-index:3;width:300px;">
      ...
      <div class="w3-container w3-row">
        <div class="w3-col s4">
          <img class="w3-circle w3-margin-right" src="https://www.muralswallpaper.co.uk/app/uploads/physical-world-map-maps-plain.jpg" style="width:46px"/>
        </div>
    ...
    <div class="w3-main" style="margin-left:300px;margin-top:43px;">
      ...
      <div class="w3-row-padding w3-margin-bottom">
        <div class="w3-quarter">
          <div class="w3-container w3-red w3-padding-16">
            <div class="w3-left">
              <i class="fa fa-comment w3-xxxlarge">
              </i>
            </div>
            <div class="w3-right">
              <h3>
        ...
        <div class="w3-quarter">
          <div class="w3-container w3-teal w3-padding-16">
            <div class="w3-left">
              <i class="fa fa-share-alt w3-xxxlarge">
              </i>
            </div>
            <div class="w3-right">
              <h3>
        ...
        <div class="w3-quarter">
          <div class="w3-container w3-orange w3-text-white w3-padding-16">
            <div class="w3-left">
              <i class="fa fa-users w3-xxxlarge">
              </i>
            </div>
            <div class="w3-right">
              <h3>
      ...
      <div class="w3-panel">
        <div class="w3-row-padding" style="margin:0 -16px">
          <div class="w3-third">
            ...
            <img alt="Google Regional Map" src="https://www.muralswallpaper.co.uk/app/uploads/physical-world-map-maps-plain.jpg" style="width:100%"/>
          </div>
          <div class="w3-twothird">
            ...
            <table class="w3-table w3-striped w3-white">
              <tr>
                <td>
                  <i class="fa fa-user w3-text-blue w3-large">
                  </i>
                </td>
                <td>
              ...
              <tr>
                <td>
                  <i class="fa fa-bell w3-text-red w3-large">
                  </i>
                </td>
                <td>
                  Database error.
              ...
              <tr>
                <td>
                  <i class="fa fa-users w3-text-yellow w3-large">
                  </i>
                </td>
                <td>
              ...
              <tr>
                <td>
                  <i class="fa fa-comment w3-text-red w3-large">
                  </i>
                </td>
                <td>
                  New comments.
              ...
              <tr>
                <td>
                  <i class="fa fa-bookmark w3-text-blue w3-large">
                  </i>
                </td>
                <td>
                  Check transactions.
              ...
              <tr>
                <td>
                  <i class="fa fa-laptop w3-text-red w3-large">
                  </i>
                </td>
                <td>
                  CPU overload.
              ...
              <tr>
                <td>
                  <i class="fa fa-share-alt w3-text-green w3-large">
                  </i>
                </td>
                <td>
                  New shares.
      ...
      <div class="w3-container">
        ...
        <div class="w3-grey">
          <div class="w3-container w3-center w3-padding w3-green" style="width:25%">
            +25%
          </div>
        </div>
        <p>
      ...
      <div class="w3-container">
        ...
        <ul class="w3-ul w3-card-4 w3-white">
          <li class="w3-padding-16">
            <img class="w3-left w3-circle w3-margin-right" src="https://www.muralswallpaper.co.uk/app/uploads/physical-world-map-maps-plain.jpg" style="width:35px"/>
